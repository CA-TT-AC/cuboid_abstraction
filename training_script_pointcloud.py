...
def run_training_pipeline(category, gpu):
  ...
  train_data = '/home/xujing/Desktop/cuboid_abstraction/data/cupboard_onlypcd.tfrecords'
  test_data = '/home/xujing/Desktop/cuboid_abstraction/data/cupboard_onlypcd.tfrecords'
  test_iter = 100
  if category == 'animal':
  ...
  for i in range(iterative_round):
    ...
    # mask predict
    log_folder = '/mnt/JuliansHDD/xuj/log/{}_{}_{}_{}/iterative_training/mask_predict_{}'.format(category, n_part_1, n_part_2, n_part_3, i)
    if not os.path.exists(log_folder): os.makedirs(log_folder);
    ...
    former_log_folder = log_folder
    # cube update
    log_folder = '/mnt/JuliansHDD/xuj/log/{}_{}_{}_{}/iterative_training/cube_update_{}'.format(category, n_part_1, n_part_2, n_part_3, i)
    if not os.path.exists(log_folder): os.makedirs(log_folder);
  ...
  # finetune
  log_folder = '/mnt/JuliansHDD/xuj/log/{}_{}_{}_{}/iterative_training/finutune'.format(category, n_part_1, n_part_2, n_part_3)
  if not os.path.exists(log_folder): os.makedirs(log_folder);
